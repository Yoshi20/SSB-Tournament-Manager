...
namespace :tournaments_crawler_uk do
  ...
  task smash_gg: :environment do
    Time.use_zone("London") {
      ...
      # doc = Nokogiri::HTML(URI.open('https://start.gg/api/-/gg_api./public/tournaments/schedule?filter={%22upcoming%22%3Atrue%2C%22videogameIds%22%3A%221386%22%2C%22countryCode%22%3A%22GB%22}&page=1&per_page=100&returnMeta=true'))
      doc = URI.open('https://start.gg/api/-/gg_api./public/tournaments/schedule?filter={%22upcoming%22%3Atrue%2C%22videogameIds%22%3A%221386%22%2C%22countryCode%22%3A%22GB%22}&page=1&per_page=100&returnMeta=true').read
