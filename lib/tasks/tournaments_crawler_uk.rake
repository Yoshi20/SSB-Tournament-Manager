...
namespace :tournaments_crawler_uk do
  ...
  task all: :environment do
    ...
    Rake::Task["tournaments_crawler_uk:braacket"].invoke
    Rake::Task["tournaments_crawler_uk:smash_gg"].invoke
  ...
  task braacket: :environment do
    Time.use_zone("London") {
      ...
      doc = Nokogiri::HTML(URI.open('https://braacket.com/tournament/search?rows=100&country=gb&game=ssbu&status=1'))
  ...
  task smash_gg: :environment do
    Time.use_zone("London") {
      ...
      # doc = Nokogiri::HTML(URI.open('https://smash.gg/api/-/gg_api./public/tournaments/schedule?filter={%22upcoming%22%3Atrue%2C%22videogameIds%22%3A%221386%22%2C%22countryCode%22%3A%22GB%22}&page=1&per_page=100&returnMeta=true'))
      doc = URI.open('https://smash.gg/api/-/gg_api./public/tournaments/schedule?filter={%22upcoming%22%3Atrue%2C%22videogameIds%22%3A%221386%22%2C%22countryCode%22%3A%22GB%22}&page=1&per_page=100&returnMeta=true').read
