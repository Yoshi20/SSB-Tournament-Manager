...
namespace :tournaments_crawler_ch do
  ...
  task smash_gg: :environment do
    ...
    # doc = Nokogiri::HTML(URI.open('https://start.gg/api/-/gg_api./public/tournaments/schedule?filter={"upcoming"%3Atrue%2C"videogameIds"%3A"1386"%2C"countryCode"%3A"CH"}&page=1&per_page=100&returnMeta=true'))
    doc = URI.open('https://start.gg/api/-/gg_api./public/tournaments/schedule?filter={"upcoming"%3Atrue%2C"videogameIds"%3A"1386"%2C"countryCode"%3A"CH"}&page=1&per_page=100&returnMeta=true').read
    ...
    # doc = Nokogiri::HTML(URI.open('https://start.gg/tournaments?per_page=100&filter=%7B%22upcoming%22%3Atrue%2C%22videogameIds%22%3A1386%2C%22countryCode%22%3A%22CH%22%7D'))
