...
namespace :tournaments_crawler_ch do
  ...
  task smash_gg: :environment do
    ...
    doc = URI.open('https://smash.gg/api/-/gg_api./public/tournaments/schedule?filter={"upcoming"%3Atrue%2C"videogameIds"%3A"1386"%2C"countryCode"%3A"CH"}&page=1&per_page=100&returnMeta=true').read
