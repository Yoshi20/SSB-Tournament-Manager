...
namespace :tournaments_crawler_ie do
  ...
  task all: :environment do
    ...
    Rake::Task["tournaments_crawler_ie:braacket"].invoke
    Rake::Task["tournaments_crawler_ie:smash_gg"].invoke
  ...
  task braacket: :environment do
    Time.use_zone("London") {
      ...
      doc = Nokogiri::HTML(URI.open('https://braacket.com/tournament/search?rows=100&country=ie&game=ssbu&status=1'))
