...
gem "nokogiri", ">= 1.13.9", "< 1.19.0" #blup: v1.18 drops ruby 3.0 support -> update ruby and remove this limmiter
...
gem 'ffi', '< 1.17.0' #blup: specific ffi version since ffi-1.17 requires ruby version >= 3.3.22
