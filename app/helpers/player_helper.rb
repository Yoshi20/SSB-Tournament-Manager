module PlayerHelper
  ...
  def counties_of_us_ca
    {
      'Alameda County': 'north',
      'Alpine County': 'north',
      'Amador County': 'north',
      'Butte County': 'north',
      ...
      'Sacramento County': 'north',
      'San Benito County': 'central',
      'San Bernardino County': 'south',
      'San Diego County': 'south',
      'San Francisco County': 'north',
      'San Joaquin County': 'north',
