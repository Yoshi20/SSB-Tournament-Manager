module PlayerHelper
  ...
  def regions_raw_from(country_code)
    if country_code == 'ch'
      ...
      ['south_east', 'london', 'north_west', 'east_of_england', 'west_midlands', 'south_west', 'yorkshire_and_the_humber', 'east_midlands', 'north_east', 'northern_ireland', 'scotland', 'wales']
    end
  end
